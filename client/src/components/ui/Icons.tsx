...
export const TextIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <path d="M4 7V5h16v2M9 5v14m-3 0h6" />
  </svg>
);
...
export const KeyIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path d="m10.5 12.5 8-8M16 4l3 3-3 3" />
  </svg>
);
